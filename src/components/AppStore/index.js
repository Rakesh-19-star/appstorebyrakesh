...
class Appstore extends Component {
  ...
  getSearchResults = () => {
    ...
    const filteredProjects = this.getFilteredApps()
    const searchResults = filteredProjects.filter(eachitem =>
      ...
      <div className="app-bg">
        ...
        <ul className="applist">
          {searchResults.map(eachItem => (
            <AppItem appsListDetails={eachItem} key={eachItem.appId} />
          ))}
        </ul>
      </div>
    )
